...
contract NFTsThatCanOwnTokens is ERC721A("", ""), Ownable, ReentrancyGuard {
  ...
  function balanceOfAt(uint256 tokenId, ERC20 token) public view returns (uint256) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        if(isSellable) {
          ...
          parts = string(abi.encodePacked("This token is locked and ubuyable!", '</text><text x="10" y="40" class="base">'));
        }
